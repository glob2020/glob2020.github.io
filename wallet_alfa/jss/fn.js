...
$('.serrr').on('click',async()=>{
	...
	}else{$('#deallink').val("https://glob2020.github.io/?d="+window.num);}
	
	$('.delsdr').html('R'+parseInt(senderid));$('.delrsv').html('R'+parseInt(getterid));
	$('.asrrs').html('<span onclick="window.open(\'https://ropsten.etherscan.io/address/'+res[0]+'\',\'_blank\')">'+res[0]+'</span>');
	if(res[1]=='0x0000000000000000000000000000000000000000'){
	$('.arrrs').html('<span onclick="window.open(\'https://ropsten.etherscan.io/address/'+res[0]+'\',\'_blank\')">'+res[0]+'</span>');}else{
	$('.arrrs').html('<span onclick="window.open(\'https://ropsten.etherscan.io/address/'+res[1]+'\',\'_blank\')">'+res[1]+'</span>');}
...
$('.ethadr').on('click', function(){if($(this).html()!='NO ADDRESS'){window.open('https://ropsten.etherscan.io/address/'+$(this).html(),'_blank');}});
...
$('#reflink').val("https://glob2020.github.io/?r="+window.usid);
$('#reflin').val("https://glob2020.github.io/?g="+window.usid);}
