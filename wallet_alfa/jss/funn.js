...
let htm = ''; for(let i=cbegin; i > cend; i--){
htm = htm + "<tr><td><small>"+window.reffs[i][2]+"</small></td><td><small>R"+window.reffs[i][1]+"</small></td><td style='cursor:pointer;'><small onclick=\"window.open(\'https://ropsten.etherscan.io/address/"+window.reffs[i][0]+"\',\'_blank\')\">"+window.reffs[i][0]+"</small></td><td><small>"+window.reffs[i][3]+"</small></td></tr>";}
$('#refln').html(htm);}}
...
let htm = ''; for(let i=cbegin; i > cend; i--){
htm = htm + "<tr><td><small>"+window.seffs[i][2]+"</small></td><td><small>R"+window.seffs[i][1]+"</small></td><td style='cursor:pointer;'><small onclick=\"window.open(\'https://ropsten.etherscan.io/address/"+window.seffs[i][0]+"\',\'_blank\')\">"+window.seffs[i][0]+"</small></td><td><small>"+window.seffs[i][3]+"</small></td></tr>";}
$('#srefln').html(htm);}}
...
/** REGISTER **/
	...
	conregg.methods.register(accounts[0],a).send({from:accounts[0],gasLimit:gas_limit,gasPrice:gas_price},function(err,result){if(!err){
	...
	'<a target="_blank" href="https://ropsten.etherscan.io/tx/'+result+
	...
	'<col width=20%><col width=20%><col width=20%><col width=20%><col width=20%><tbody>'+
		...
		'<small style="cursor:pointer;" onclick=\'window.open("https://ropsten.etherscan.io/address/'+
	...
	$('.pay_link').val("https://glob2020.github.io/?r="+window.usid);}
	...
	$('.pay_link').val("https://glob2020.github.io/?r="+window.usid+'l'+vall);}
	if(typeof ethereum !== 'undefined'){
	if(typeof accounts !== 'undefined'){
	if(window.usid>0){	
	$('.pay_link').removeClass('hidden');	
	...
	if(!!window.topp){
		...
		$('#airlinn').val("https://glob2020.github.io/?g="+window.usid);}
